---
type: document
title: Additional guide to using the Site Editor
description: ""
resource: "https://bountiful-impassioned-hygiea.wpcloudstation.dev/wordpress-org-documentation/article/additional-guide-to-using-the-site-editor/"
tags:
...
wordpress:
  ...
  slug: additional-guide-to-using-the-site-editor
  parent: 0
  menu_order: 0
  comment_status: closed
  ping_status: closed
  guid: "https://bountiful-impassioned-hygiea.wpcloudstation.dev/wordpress-org-documentation/article/additional-guide-to-using-the-site-editor/"
  comment_count: 0
  terms:
    category:
      - appearance
...
![Image showing the options to set a site logo as a site icon in the settings sidebar. ](https://wordpress.org/documentation/files/2022/01/site_icon-1024x914.png)## How to customize your site design at a global level
