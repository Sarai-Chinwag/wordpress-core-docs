---
type: document
title: Become a WordPress contributor
description: ""
resource: "https://bountiful-impassioned-hygiea.wpcloudstation.dev/wordpress-org-documentation/article/become-a-wordpress-contributor/"
tags:
...
wordpress:
  ...
  slug: become-a-wordpress-contributor
  parent: 0
  menu_order: 0
  comment_status: closed
  ping_status: closed
  guid: "https://bountiful-impassioned-hygiea.wpcloudstation.dev/wordpress-org-documentation/article/become-a-wordpress-contributor/"
  comment_count: 0
  terms:
    category:
      - about-wp
...
If you’d like to help, visit <https://make.wordpress.org/support/> for more information.
...
There is a weekly [meetup of core developers](https://make.wordpress.org/core/weekly-developer-chats/) in #core on Slack. Agendas, minutes, and discussion between meetups all take place on the [WordPress Development Blog](https://make.wordpress.org/core/).

While the IRC Live chat is still active, our Slack Channel is where we are getting work done. Please join us on Slack: [https://make.wordpress.org/chat/](https://make.wordpress.org/chat/.)
...
If you want to be on the bleeding edge of development, even before pre-release versions are put together, you can also check out the latest software from the WordPress Subversion (SVN) repository, as outlined in [Using Subversion](https://codex.wordpress.org/Using_Subversion). Or, you can get the “nightly build” (which is created from the Subversion repository, and available as a zip file) at <https://wordpress.org/nightly-builds/wordpress-latest.zip> — almost as up-to-date as the instantaneous Subversion repository.
...
## Explore more contribution opportunities

The areas above are a great starting point, but they are not the only ways to contribute to WordPress. If you’d like more guided options, the [Contribution Pathways page](https://make.wordpress.org/handbook/pathways/) can help you find specific tasks, projects, and routes into contribution.

Each pathway includes practical steps, helpful resources, and links to where the work happens, so you can choose something that fits your interests, experience, and available time.

[Explore Contribution Pathways](https://make.wordpress.org/handbook/pathways/)
